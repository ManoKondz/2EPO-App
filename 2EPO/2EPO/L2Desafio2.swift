...
// Definição da tela principal para o desafio 2
            ...
            ZStack {
                ...
                VStack {
                    ...
                    .overlay(
                        ...
                        CustomPopupView6(isCorrect: isCorrect, showing: $showingResult, navigateToNextScreen: $navigateToNextScreen)
                    )
                    ...
                    .navigationDestination(isPresented: $navigateToNextScreen) {
                        L2Desafio3() // Próxima tela após o desafio
                    }
...
#Preview {
    L2Desafio2() // Exibe a visualização da tela
}
