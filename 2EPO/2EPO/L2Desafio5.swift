            ...
            ZStack {
                ...
                VStack {
                    ...
                    VStack{
                        ...
                        // Botão de som
                        Button(action: {
                            voiceSynthesizer.speak("A mamãe começou o provérbio com “quem tudo quer __________”.Como você ajudaria ela a ajudaria ela a completar esse provérbio para ganhar os deliciosos biscoitos ?")
