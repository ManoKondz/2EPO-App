...
// Definição da tela principal para o desafio 5
            ...
            ZStack {
                ...
                VStack {
                    ...
                    VStack {
                        ...
                        Button(action: {
                            voiceSynthesizer.speak("A mamãe começou o provérbio com “quem tudo quer __________”. Como você ajudaria ela a completar esse provérbio para ganhar os deliciosos biscoitos?")
                    ...
                    .overlay(
                        ...
                        CustomPopupView9(isCorrect: isCorrect, showing: $showingResult, navigateToNextScreen: $navigateToNextScreen)
                    )
                    ...
                    .navigationDestination(isPresented: $navigateToNextScreen) {
                        L2Desafio5() // Próxima tela do desafio
                    }
                }
            }
        }
...
#Preview {
    L2Desafio5() // Exibe a visualização da tela
}
